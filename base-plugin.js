 ...
 * Shim: base-plugin.js
 *
 * Minimal reproduction of SquadJS 4.1.0 BasePlugin for testing.
 * The real file lives at squad-server/plugins/base-plugin.js in the
 * SquadJS installation.
 */
...
export default class BasePlugin {
    ...
    verbose(...args) {
        // Silently log in tests, or use console for debugging
    }
